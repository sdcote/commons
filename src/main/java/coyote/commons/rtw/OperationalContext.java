...
/**
 * This is an operational context base class providing basic data context
 * functions.
 *
 * <p>This operational context allows components to share data amongst each
 * other while remaining functionally separate.</p>
 *
...
public class OperationalContext {
     ...
     */
    protected List<ContextListener> listeners = new ArrayList<>();
    ...
    public void setErrorMessage(String errMsg) {
        if (errorMessage == null) {
            errorMessage = new StringBuilder(errMsg);
        } else {
            errorMessage.append("\n");
    ...
    public String dump() {
        StringBuilder b = new StringBuilder("Context Properties:");
     ...
     * does not retrieve the symbol table values, start time, state, error
    ...
    public List<String> getKeys() {
        List<String> retval = new ArrayList<>(properties.size());
        for (String key : properties.keySet()) {
            retval.add(key);
        }
        return retval;
