...
import coyote.commons.rtw.context.ContextKey;
...
public abstract class AbstractTransformEngine extends AbstractConfigurableComponent implements TransformEngine, ConfigurableComponent {
    ...
    public static String formatDateTime(Date date) {
        if (date == null)
            ...
            return new SimpleDateFormat(RTW.DEFAULT_DATETIME_FORMAT).format(date);
    }
    ...
    public static String formatDate(Date date) {
        if (date == null)
            ...
            return new SimpleDateFormat(RTW.DEFAULT_DATE_FORMAT).format(date);
    }
    ...
    public static String formatTime(Date date) {
        if (date == null)
            ...
            return new SimpleDateFormat(RTW.DEFAULT_TIME_FORMAT).format(date);
    }
    ...
    private void determineWorkDirectory() {
        ...
        if (StringUtil.isBlank(System.getProperty(BootStrap.APP_HOME))) {
            System.setProperty(BootStrap.APP_HOME, System.getProperty("user.dir"));
            Log.debug("APP.HOME is not set, setting it to the current directory: " + System.getProperty(BootStrap.APP_HOME));
        }
