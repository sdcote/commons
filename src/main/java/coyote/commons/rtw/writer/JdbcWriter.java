...
import coyote.commons.jdbc.*;
import coyote.commons.log.Log;
import coyote.commons.rtw.ConfigTag;
import coyote.commons.rtw.ConfigurableComponent;
import coyote.commons.rtw.DataSetMetrics;
            ...
            try {
                switch (type) {
                    ...
                    case DataField.STRING:
                        ...
                        break;
                    case DataField.S8:
                        Log.debug(String.format("Database.saving_field_as", getClass().getSimpleName(), field.getName(), indx, "S8-byte"));
                        if (field.isNull()) {
                    ...
                    case DataField.U8:
                    case DataField.S16:
                        Log.debug(String.format("Database.saving_field_as", getClass().getSimpleName(), field.getName(), indx, "S16-Short"));
                        if (field.isNull()) {
                    ...
                    case DataField.U16:
                    case DataField.S32:
                        Log.debug(String.format("Database.saving_field_as", getClass().getSimpleName(), field.getName(), indx, "S32-Integer"));
                        if (field.isNull()) {
                    ...
                    case DataField.S64:
                    case DataField.U64:
                        Log.debug(String.format("Database.saving_field_as", getClass().getSimpleName(), field.getName(), indx, "S64-Long"));
                        if (field.isNull()) {
                    ...
                    case DataField.FLOAT:
                        Log.debug(String.format("Database.saving_field_as", getClass().getSimpleName(), field.getName(), indx, "Float"));
                        if (field.isNull()) {
                    ...
                    case DataField.DOUBLE:
                        Log.debug(String.format("Database.saving_field_as", getClass().getSimpleName(), field.getName(), indx, "Double"));
                        if (field.isNull()) {
                    ...
                    case DataField.BOOLEANTYPE:
                        Log.debug(String.format("Database.saving_field_as", getClass().getSimpleName(), field.getName(), indx, "Boolean"));
                        if (field.isNull()) {
                        ...
                        break;
                    case DataField.DATE:
                        Log.debug(String.format("Database.saving_field_as", getClass().getSimpleName(), field.getName(), indx, "Timestamp"));
                        if (field.isNull()) {
        ...
        if (SQL == null) {
            ...
            if (checkTable()) {
                ...
                try {
                    ...
                    getContext().setError(String.format("Writer.preparedstatement_exception", getClass().getSimpleName(), e.getMessage()));
                }
                if (ps == null) {
                    String errorMessage = String.format("Writer.preparedstatement_null", getClass().getSimpleName());
