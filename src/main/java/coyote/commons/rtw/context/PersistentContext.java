      ...
      try {
        ...
        if (prevrun != null) {
          ...
          if (this.symbols != null) {
            symbols.put(Symbols.PREVIOUS_RUN_DATE, new SimpleDateFormat(RTW.DEFAULT_DATE_FORMAT).format(prevrun));
            symbols.put(Symbols.PREVIOUS_RUN_TIME, new SimpleDateFormat(RTW.DEFAULT_TIME_FORMAT).format(prevrun));
            symbols.put(Symbols.PREVIOUS_RUN_DATETIME, new SimpleDateFormat(RTW.DEFAULT_DATETIME_FORMAT).format(prevrun));
