...
public class LdapReader extends AbstractFrameReader {
    ...
    public void open(TransformContext context) {
        ...
        try {
            ...
            context.setError(String.format( "Reader.could_not_read_from_source", getClass().getName(), e.getClass().toString() + ": " + e.getMessage()).toString());
        }

        if (connection == null) {
            context.setError(String.format( "Reader.could_not_read_from_source", getClass().getName(), "Could not connect to directory service at '" + providerUrl + "'").toString());
        } else {
            performSearch();
        }
    }
    ...
    private void performSearch() {
        ...
        try {
            ...
            String errorMessage = String.format( "Reader.could_not_read_from_source", getClass().getName(), e.getClass().getName() + ": " + e.getMessage()).toString();
