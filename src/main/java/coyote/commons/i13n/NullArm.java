...
public class NullArm implements ArmTransaction {
  ...
  /**
   * @see coyote.i13n.NullArm#decrement(String)
   */
  @Override
  ...
  /**
   * @see coyote.i13n.NullArm#increase(String, long)
   */
  @Override
  ...
  /**
   * @see coyote.i13n.NullArm#increment(String)
   */
  @Override
  ...
  /**
   * @see coyote.i13n.ArmTransaction#setCRID(String)
   */
  @Override
  ...
  /**
   * @see coyote.i13n.NullArm#update(String, Object)
   */
  @Override
