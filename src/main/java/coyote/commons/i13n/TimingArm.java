...
public final class TimingArm extends NullArm {
  ...
  */
  ...
  /**
   * @see coyote.i13n.ArmTransaction#decrease(String, long)
   */
  @Override
  ...
  /**
   * @see coyote.i13n.ArmTransaction#decrement(String)
   */
  @Override
  ...
  /**
   * @see coyote.i13n.ArmTransaction#increase(String, long)
   */
  @Override
  ...
  /**
   * @see coyote.i13n.ArmTransaction#increment(String)
   */
  @Override
  ...
  /**
   * @see coyote.i13n.ArmTransaction#startArm(String)
   */
  @Override
  ...
  /**
   * @see coyote.i13n.ArmTransaction#startArm(String, String)
   */
  @Override
  ...
  /**
   * @see coyote.i13n.ArmTransaction#update(String, Object)
   */
  @Override
