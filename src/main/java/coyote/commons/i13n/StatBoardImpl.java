...
public class StatBoardImpl implements StatBoard {
    ...
    public float getHeapPercentage() {
        return 1 - ((float) getAvailableMemory() / (float) getMaxHeapSize()); // percent of max
    }
    ...
    public float getUsedMemoryPercentage() {
        return 1 - ((float) getFreeMemory() / (float) getMaxHeapSize()); // percent of max
    }
    ...
    public float getFreeMemoryPercentage() {
        return (float) getFreeMemory() / (float) getMaxHeapSize();
    }
