...
/**
 * Implements the &quot;Cipher Block Chaining Mode&quot;. As cipher the class {@link Aes256} will be used.
 */
public class Cbc {
    ...
    /**
     * Encrypts a part of the array. Only the first {@code length} {@code byte}s of the array will be encrypted.
     *
     * @param data {@code byte}s that should be encrypted
    ...
    /**
     * Decrypts a part of the array. Only the first {@code length} {@code byte}s of the array will be decrypted.
     *
     * @param data {@code byte}s that should be decrypted
