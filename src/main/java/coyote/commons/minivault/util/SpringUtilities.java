...
public class SpringUtilities {
   ...
   *
   * <p>Each component in a column is as wide as the maximum preferred width of the components in that column; height
   * is similarly determined for each row. The parent is made just big enough to fit them all.</p>
   *
   * @param parent   parent container
   * @param rows     number of rows
   * @param cols     number of columns
