...
public class JSONTokenizer {
  ...
  /**
   * Construct a JSONTokenizer from a Reader. The caller must close the Reader.
   *
  ...
  /**
   * Construct a JSONTokenizer from an InputStream. The caller must close the input stream.
   *
