 ...
 *
 * <p>Its external text form is a string wrapped in square brackets with commas separating the values. The internal
 * form is an object having <code>get</code> and <code>opt</code> methods for accessing the values by index, and
 ...
 *
 * <p>The constructor can convert a JSON text into a Java object. The <code>toString</code> method converts to JSON
 * text.</p>
 *
 ...
 * you.</p>
 *
 * <p>The texts produced by the <code>toString</code> methods strictly conform to JSON syntax rules. The constructors
 * are more forgiving in the texts they will accept:<ul>
