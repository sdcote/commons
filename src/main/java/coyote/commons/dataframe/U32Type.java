...
public class U32Type implements FieldType {
  ...
  public boolean checkType( Object obj ) {
    return ( ( obj instanceof Byte && ( (Byte)obj ).byteValue() >= 0 ) || ( obj instanceof Short && ( (Short)obj ).shortValue() >= 0 ) || ( obj instanceof Integer && ( (Integer)obj ).intValue() >= 0 ) || ( obj instanceof Long && ( (Long)obj ).longValue() >= 0 && ( (Long)obj ).longValue() <= 4294967295L ) );
  }
