...
public class U16Type implements FieldType {
  ...
  public boolean checkType( Object obj ) {
    return ( ( obj instanceof Byte && ( (Byte)obj ).byteValue() >= 0 ) || ( obj instanceof Short && ( (Short)obj ).shortValue() >= 0 ) || ( obj instanceof Integer && ( (Integer)obj ).intValue() >= 0 && ( (Integer)obj ).intValue() <= 65535 ) );
  }
