...
public class FrameFormatter {
    ...
    private final static List<String> ESCAPE_STRINGS = Collections.unmodifiableList(Arrays.asList("&lt;", "&gt;", "&amp;", "&quot;", "&apos;"));
    private static final String UNICODE_LOW = "" + ((char) 0x20); //space
    private static final String UNICODE_HIGH = "" + ((char) 0x7f);
    ...
    public static String dump(DataFrame frame) {
        ...
        String buffer = "DataFrame of " +
                length +
                " bytes" +
                LINE_FEED +
                ByteUtil.dump(frame.getBytes(), length) +
                LINE_FEED;
