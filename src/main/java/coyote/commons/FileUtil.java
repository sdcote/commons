...
public final class FileUtil {
     ...
     */
    public static void append(final File file, final byte[] data, final boolean backup) throws IOException {
...
//      }
     ...
     * @return true if the file was deleted or does not exist, false otherwise
     */
    public static boolean deleteFile(final String fname) {
     ...
     * @throws IOException if there were problems
     */
    public static void deleteFile(final String dataDir, final String fname) throws IOException {
     ...
     * file.
     *
     * <p>This will return an empty string if the files does not exist, or if
     * the file cannot be read, or if the file is empty. This should never
     * return null.</p>
     *
     ...
     */
    public static List<File> getAllFiles(final String path, final String suffix, final boolean recurse) {
     ...
     * @param classname
     */
    public static String getJavaFile(final String classname) {
     ...
     */
    public static String getJavaBasePath(final String classname) {
     ...
     */
    public static File getJavaClassFile(final File dir, final String classname) {
        File retval = null;
     ...
     * @return the file containing the class
     */
    public static File getJavaClassFile(final String classname) {
     ...
     */
    public static File getJavaSourceFile(final File dir, final String classname) {
        File retval = null;
     ...
     */
    public static File getJavaSourceFile(final String classname) {
     ...
     * @throws IOException if there were problems
     */
    public static void removeDir(final File dir) throws IOException {
     ...
     *
     */
    public static String getJavaPath(final String classname) {
        if (classname.endsWith(".class")) {
     ...
     */
    public static void delFile(final String fname) throws NullPointerException, IOException {
     ...
     * @throws NullPointerException
     */
    public static void delFile(final String dataDir, final String fname) throws NullPointerException, IOException {
        final File f = new File(dataDir + FileUtil.FILE_SEPARATOR + fname);
