...
public class WebSocketFrame {
  ...
  public static WebSocketFrame read(final InputStream in) throws IOException {
    ...
    final OpCode opCode = OpCode.find((byte)(head & 0x0F));
    if ((head & 0x70) != 0) {
  ...
  public WebSocketFrame(final OpCode opCode, final boolean fin, final byte[] payload) {
  ...
  public WebSocketFrame(final OpCode opCode, final boolean fin, final byte[] payload, final byte[] maskingKey) {
    this(opCode, fin);
  ...
  public WebSocketFrame(final OpCode opCode, final boolean fin, final String payload) throws CharacterCodingException {
    this(opCode, fin, payload, null);
  }
  ...
  public WebSocketFrame(final OpCode opCode, final boolean fin, final String payload, final byte[] maskingKey) throws CharacterCodingException {
    this(opCode, fin);
    setMaskingKey(maskingKey);
  ...
  public WebSocketFrame(final OpCode opCode, final List<WebSocketFrame> fragments) throws WebSocketException {
    setOpCode(opCode);
    setFin(true);
  ...
  private WebSocketFrame(final OpCode opCode, final boolean fin) {
    setOpCode(opCode);
    setFin(fin);
  }
  ...
  public static enum CloseCode {
    ...
    public static CloseCode find(final int value) {
      for (final CloseCode code : values()) {
  ...
  public static class CloseFrame extends WebSocketFrame {
    ...
    private static byte[] generatePayload(final CloseCode code, final String closeReason) throws CharacterCodingException {
      if (code != null) {
    ...
    public CloseFrame(final CloseCode code, final String closeReason) throws CharacterCodingException {
  ...
  public static enum OpCode {
    ...
    public static OpCode find(final byte value) {
