...
public final class Log {
    ...
    /**
     * Set how deep formatters should go into the stack to locate the actual
     * source of the event.
     *
    ...
    public static synchronized void append(final String category, final Object event, final Throwable cause) {
        LogKernel.append(Log.getCode(category), event, cause);
    }
    ...
    /**
     * This stops all loggers logging all categories by setting the category mask to all zeros.
     */
    public static void stopLoggingAllCategories() {
        LogKernel.setMask(0L);
    }

    /**
     * This starts logging for all the categories.
     */
    public static void startLoggingAllCategories() {
        LogKernel.setMask(-1L);
    }
