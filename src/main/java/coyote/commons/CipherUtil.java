...
public class CipherUtil {
  ...
  public static final String CIPHER_NAME_TAG = "cipher.name";

  /** Name ({@value}) of the system property containing the Base64 cipher key value. */
  public static final String CIPHER_KEY_TAG = "cipher.key";
  ...
  public static String encryptString( String clearText ) {
    String retval = null;
    String key = System.getProperty( CIPHER_KEY_TAG, CipherUtil.getKey( CIPHER_KEY ) );
    String cipherName = System.getProperty( CIPHER_NAME_TAG, CIPHER_NAME );
