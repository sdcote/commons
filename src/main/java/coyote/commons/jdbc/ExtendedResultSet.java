...
public interface ExtendedResultSet extends ResultSet {
   ...
   */
  <E extends Enum<E>> E getEnum( int columnIndex, Class<E> enumClz ) throws SQLException;
   ...
   *                       is called on a closed result set
   */
  <E extends Enum<E>> E getEnum( String columnLabel, Class<E> enumClz ) throws SQLException;
