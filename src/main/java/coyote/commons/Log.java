 ...
 * Internal logger.
 *
 * <p>This is not a full-features logger. It only is intended to provide formatted log messages to whatever output
 * stream is selected. The default is SYSOUT.</p>
 *
 * <p>This allows developers to remove {@code System.out.println( "");} statements from their code. For many, this is
 * all the logging that is required.</p>
 * <p>
