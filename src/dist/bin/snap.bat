...
@rem ##########################################################################
@rem
@rem  Snap startup script for Windows
@rem
@rem ##########################################################################

if "%HOME%"=="" goto homeDrivePathPre
if exist "%HOME%\snap_pre.bat" call "%HOME%\snap_pre.bat"
...
if exist "%HOMEDRIVE%%HOMEPATH%\snap_pre.bat" call "%HOMEDRIVE%%HOMEPATH%\snap_pre.bat"
...
if exist "%USERPROFILE%\snap_pre.bat" call "%USERPROFILE%\snap_pre.bat"
...
@rem Add default JVM options here. You can also use JAVA_OPTS and SNAP_OPTS to
...
@rem - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
:fail
@rem Set variable SNAP_EXIT_CONSOLE if you need the _script_ return code 
@rem instead of the _cmd.exe /c_ return code!
@rem   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -
if  not "" == "%SNAP_EXIT_CONSOLE%" exit 1
exit /b 1
...
if exist "%HOME%\snap_post.bat" call "%HOME%\snap_post.bat"

@rem - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
:homeDrivePathPost
if "%HOMEDRIVE%%HOMEPATH%"=="" goto userProfilePost
if "%HOMEDRIVE%%HOMEPATH%"=="%HOME%" goto userProfilePost
if exist "%HOMEDRIVE%%HOMEPATH%\snap_post.bat" call "%HOMEDRIVE%%HOMEPATH%\snap_post.bat"
...
if exist "%USERPROFILE%\snap_post.bat" call "%USERPROFILE%\snap_post.bat"
