 ...
 * 
 * <p>This models a few tables in a manner common to a ServiceNow instance.</p>
 * 
...
public class ModelMarshal {
  ...
  public static void main(String[] args) {
    ...
    sysUser.setTaggedValue("documentation", "This is a &lt;b&gt;system&lt;/b&gt; table which holds all the users of the system.");
    ...
    // For each reference create an association to the sys_id of the referenced table
    ...
    element.setGeometry("Left=10;Top=10;Right=288;Bottom=616;"); // configure where on the diagram this is to display
    ...
    Xmi11Marshaler.setName("Enterprise Architect");
    Xmi11Marshaler.setVersion("2.5");

    String xml = Xmi11Marshaler.marshal(model, true);
