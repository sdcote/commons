...
//    response.close();
    ...
    public void testError404UriResponderGetMimeType() {
        assertEquals("text/html", new Error404Responder().getMimeType(), "Error404UriResponder mime type should be text/html");
    }


    @Test
    public void testError404UriResponderGetStatus() {
        assertEquals(Status.NOT_FOUND, new Error404Responder().getStatus(), "Error404UriResponder#getStatus should return NOT_FOUND status");
    }


    @Test
    public void testGeneralResponderGetStatus() {
        assertEquals(Status.OK, new GeneralResponder().getStatus(), "GeneralResponder#getStatus should return OK status");
    }


    @Test
    public void testNotImplementedResponderGetMimeType() {
        assertEquals( "text/html", new NotImplementedResponder().getMimeType(),"NotImplementedResponder mime type should be text/html");
    }


    @Test
    public void testNotImplementedResponderGetStatus() {
        assertEquals(Status.NOT_IMPLEMENTED, new NotImplementedResponder().getStatus(), "NotImplementedResponder#getStatus should return OK status");
    }


    @Test
    public void testStaticPageResponderGetStatus() {
        assertEquals(Status.OK, new StaticPageResponder().getStatus(), "StaticPageResponder#getStatus should return OK status");
    }
    ...
    public void testResourceMatch() {
        ...
        assertNull(resource.match("/xyz/pqr/"), "Resource should not match incorrect URL, and thus, should not return a URI parameter map");
        assertNotNull(resource.match("browse"), "Resource should match the correct URL, and thus, should return a URI parameter map");
    }
