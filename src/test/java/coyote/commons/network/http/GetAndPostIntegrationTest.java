...
public class GetAndPostIntegrationTest extends IntegrationTestBase<GetAndPostIntegrationTest.TestServer> {
    ...
    public void testPostRequestWithMultipartExtremEncodedParameters() throws Exception {
        ...
        final MultipartEntity reqEntity = new MultipartEntity(HttpMultipartMode.BROWSER_COMPATIBLE, "sfsadfasdf", StandardCharsets.UTF_8);
        reqEntity.addPart("specialString", new StringBody("æ‹–æ‹‰å›¾ç‰‡åˆ°æµ�è§ˆå™¨ï¼Œå�¯ä»¥å®žçŽ°é¢„è§ˆåŠŸèƒ½", "text/plain", StandardCharsets.UTF_8));
        reqEntity.addPart("gender", new StringBody("å›¾ç‰‡å��ç§°", StandardCharsets.UTF_8) {
