...
public class FileUtilCopyTest {
    ...
    public void testDirectory() {
        ...
        try {
            ...
            File httpd = new File(resources, "httpd");
            assertTrue(httpd.exists());
            assertTrue(httpd.isDirectory());

            File props = new File(httpd, "default-mimetypes.properties");
    ...
    public void testDirectoryPattern() {
        ...
        try {
            ...
            File commons = new File(coyote, "commons");
            assertTrue(commons.exists());
            assertTrue(commons.isDirectory());

            File watchdog = new File(commons, "FileUtil.java");
