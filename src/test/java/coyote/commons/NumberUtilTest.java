...
public class NumberUtilTest {
    ...
    public void parse() {
        ...
        assertEquals(Float.valueOf("-1234.5"), NumberUtil.parse("-1234.5"));
        assertEquals(Integer.valueOf("-12345"), NumberUtil.parse("-12345"));
        assertEquals(0xFADE, NumberUtil.parse("0xFADE").intValue());
        assertEquals(0xFADE, NumberUtil.parse("0Xfade").intValue());
        assertEquals(-0xFADE, NumberUtil.parse("-0xFADE").intValue());
        assertEquals(-0xFADE, NumberUtil.parse("-0Xfade").intValue());
        ...
        assertNull(NumberUtil.parse(null));
    ...
    public void parseBigDecimal() {
        ...
        assertNull(NumberUtil.parseBigDecimal(null));
    ...
    public void parseBigInteger() {
        ...
        assertNull(NumberUtil.parseBigInteger(null));
    ...
    public void parseInteger() {
        ...
        assertNull(NumberUtil.parseInteger(null));
        parseIntegerFailure("");
        parseIntegerFailure(" ");
    ...
    public void testJdkAssumptions() {
        ...
        assertEquals(+1, Double.compare(Double.NaN, Double.MAX_VALUE));
        assertEquals(+1, Double.compare(Double.NaN, 1.2d));
        assertEquals(+1, Double.compare(Double.NaN, 0.0d));
        assertEquals(+1, Double.compare(Double.NaN, -0.0d));
        assertEquals(+1, Double.compare(Double.NaN, -1.2d));
        assertEquals(+1, Double.compare(Double.NaN, -Double.MAX_VALUE));
        ...
        assertEquals(+1, Double.compare(Double.POSITIVE_INFINITY, Double.MAX_VALUE));
        assertEquals(+1, Double.compare(Double.POSITIVE_INFINITY, 1.2d));
        assertEquals(+1, Double.compare(Double.POSITIVE_INFINITY, 0.0d));
        assertEquals(+1, Double.compare(Double.POSITIVE_INFINITY, -0.0d));
        assertEquals(+1, Double.compare(Double.POSITIVE_INFINITY, -1.2d));
        assertEquals(+1, Double.compare(Double.POSITIVE_INFINITY, -Double.MAX_VALUE));
        assertEquals(+1, Double.compare(Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY));

        assertEquals(-1, Double.compare(Double.MAX_VALUE, Double.NaN));
        assertEquals(-1, Double.compare(Double.MAX_VALUE, Double.POSITIVE_INFINITY));
        assertEquals(0, Double.compare(Double.MAX_VALUE, Double.MAX_VALUE));
        assertEquals(+1, Double.compare(Double.MAX_VALUE, 1.2d));
        assertEquals(+1, Double.compare(Double.MAX_VALUE, 0.0d));
        assertEquals(+1, Double.compare(Double.MAX_VALUE, -0.0d));
        assertEquals(+1, Double.compare(Double.MAX_VALUE, -1.2d));
        assertEquals(+1, Double.compare(Double.MAX_VALUE, -Double.MAX_VALUE));
        assertEquals(+1, Double.compare(Double.MAX_VALUE, Double.NEGATIVE_INFINITY));

        assertEquals(-1, Double.compare(1.2d, Double.NaN));
        assertEquals(-1, Double.compare(1.2d, Double.POSITIVE_INFINITY));
        assertEquals(-1, Double.compare(1.2d, Double.MAX_VALUE));
        assertEquals(0, Double.compare(1.2d, 1.2d));
        assertEquals(+1, Double.compare(1.2d, 0.0d));
        assertEquals(+1, Double.compare(1.2d, -0.0d));
        assertEquals(+1, Double.compare(1.2d, -1.2d));
        assertEquals(+1, Double.compare(1.2d, -Double.MAX_VALUE));
        assertEquals(+1, Double.compare(1.2d, Double.NEGATIVE_INFINITY));

        assertEquals(-1, Double.compare(0.0d, Double.NaN));
        assertEquals(-1, Double.compare(0.0d, Double.POSITIVE_INFINITY));
        assertEquals(-1, Double.compare(0.0d, Double.MAX_VALUE));
        assertEquals(-1, Double.compare(0.0d, 1.2d));
        assertEquals(0, Double.compare(0.0d, 0.0d));
        assertEquals(+1, Double.compare(0.0d, -0.0d));
        assertEquals(+1, Double.compare(0.0d, -1.2d));
        assertEquals(+1, Double.compare(0.0d, -Double.MAX_VALUE));
        assertEquals(+1, Double.compare(0.0d, Double.NEGATIVE_INFINITY));
        ...
        assertEquals(-1, Double.compare(Double.NEGATIVE_INFINITY, Double.MAX_VALUE));
        assertEquals(-1, Double.compare(Double.NEGATIVE_INFINITY, 1.2d));
        assertEquals(-1, Double.compare(Double.NEGATIVE_INFINITY, 0.0d));
        assertEquals(-1, Double.compare(Double.NEGATIVE_INFINITY, -0.0d));
        assertEquals(-1, Double.compare(Double.NEGATIVE_INFINITY, -1.2d));
        assertEquals(-1, Double.compare(Double.NEGATIVE_INFINITY, -Double.MAX_VALUE));
        ...
        assertEquals(+1, Float.compare(Float.POSITIVE_INFINITY, Float.MAX_VALUE));
        ...
        assertEquals(-1, Float.compare(Float.MAX_VALUE, Float.NaN));
        assertEquals(-1, Float.compare(Float.MAX_VALUE, Float.POSITIVE_INFINITY));
        assertEquals(0, Float.compare(Float.MAX_VALUE, Float.MAX_VALUE));
        assertEquals(+1, Float.compare(Float.MAX_VALUE, 1.2f));
        assertEquals(+1, Float.compare(Float.MAX_VALUE, 0.0f));
        assertEquals(+1, Float.compare(Float.MAX_VALUE, -0.0f));
        assertEquals(+1, Float.compare(Float.MAX_VALUE, -1.2f));
        assertEquals(+1, Float.compare(Float.MAX_VALUE, -Float.MAX_VALUE));
        assertEquals(+1, Float.compare(Float.MAX_VALUE, Float.NEGATIVE_INFINITY));

        assertEquals(-1, Float.compare(1.2f, Float.NaN));
        assertEquals(-1, Float.compare(1.2f, Float.POSITIVE_INFINITY));
        assertEquals(-1, Float.compare(1.2f, Float.MAX_VALUE));
        assertEquals(0, Float.compare(1.2f, 1.2f));
        assertEquals(+1, Float.compare(1.2f, 0.0f));
        assertEquals(+1, Float.compare(1.2f, -0.0f));
        assertEquals(+1, Float.compare(1.2f, -1.2f));
        assertEquals(+1, Float.compare(1.2f, -Float.MAX_VALUE));
        ...
        assertEquals(-1, Float.compare(0.0f, Float.MAX_VALUE));
        ...
        assertEquals(-1, Float.compare(Float.NEGATIVE_INFINITY, Float.MAX_VALUE));
