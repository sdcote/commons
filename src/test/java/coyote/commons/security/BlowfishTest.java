...
public class BlowfishTest {
    ...
    public void testBasicUseCase() throws Exception {
        ...
        cipher.init(secret.getBytes(StandardCharsets.UTF_8)); // use UTF16 for larger character sets

        // Encrypt the text with the UTF16 encoded bytes our our clear text string
        byte[] cipherdata = cipher.encrypt(cleartext.getBytes(StandardCharsets.UTF_8));
        ...
        cipher2.init(secret.getBytes(StandardCharsets.UTF_8));

        // Decrypt the data
        byte[] cleardata = cipher2.decrypt(cipherdata);

        String newtext = new String(cleardata, StandardCharsets.UTF_8);
    ...
    public void testAgainstInternal() throws Exception {
        ...
        byte[] plainData = cleartext.getBytes(StandardCharsets.UTF_8);
